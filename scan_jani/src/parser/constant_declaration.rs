...
pub(crate) struct ConstantDeclaration {
    ...
    name: Identifier,
    r#type: Type, // the constant's type; bounded types must not refer to this constant or
    // constants declared after this one in the corresponding array
    value: Option<Expression>, // the constant's value, of type type; constant expression that must not refer to this
